...
class OrderResolved extends StatefulWidget {
  const OrderResolved({super.key});

  @override
  State<OrderResolved> createState() => _OrderResolvedState();
}

class _OrderResolvedState extends State<OrderResolved> {
